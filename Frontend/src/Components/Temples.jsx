  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        marginBottom: '40px',
        fontSize: '1rem',
      }}>Explore divine destinations across India</p>
      ...
      <Link to='/ulogin' style={{ textDecoration: 'none' }}>
        <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap', padding: '0 20px' }}>
          <TempleCard
            ...
            title="Shri Banke Bihari Ji Mandir"
            description="Book online darshan at one of Vrindavan's most revered temples."
          />
          <TempleCard
            ...
            description="Experience the divine at this sacred cave temple in Jammu."
          />
          <TempleCard
            imageSrc="https://upload.wikimedia.org/wikipedia/commons/4/4e/Tirumala_090615.jpg"
            title="Tirupati Tirumala Temple"
            description="Book darshan at the world's richest Hindu temple."
          />
        </div>
